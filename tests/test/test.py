...
for case, example in cases.items():
    if example:
        ...
        if case == 'Case 4':
            print(f"\n{case}:")
            print(f"Text: {example[6]['text']}")
            print(f"True Label: {example[6]['true_label']}")
            print(f"Predicted Label: {example[6]['pred_label']}")
        if case == 'Case 5':
            print(f"\n{case}:")
        ...
        if case == 'Case 6':
            print(f"\n{case}:")
            print(f"Text: {example[10]['text']}")
            print(f"True Label: {example[10]['true_label']}")
            print(f"Predicted Label: {example[10]['pred_label']}")
